        ...
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 p-8 sm:p-12 lg:p-16">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-slate-300">
              I&rsquo;m currently available for freelance projects and contract
              work. Whether you need a full website, a complex web app, or
              technical consulting — let&rsquo;s talk.
            </p>
